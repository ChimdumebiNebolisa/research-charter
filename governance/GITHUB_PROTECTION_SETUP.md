...
After reviewing the amended foundation commit and creating the `foundation-v2` tag, while preserving the immutable `foundation-v1` tag:
...
7. Preserve `foundation-v1`; preserve or create a protected tag rule for the active `foundation-v2` and later foundation-version tags.
